package cn.crabapples.file.config;

import cn.crabapples.file.properties.ConfigProperties;
...
@ConditionalOnProperty(//存在对应配置信息时初始化该配置类
        prefix = "crabapples.package",//存在配置前缀
        value = "enabled",//开启
        matchIfMissing = true//缺失检查
)
public class PackageUtilsAutoConfiguration {
    @Bean
